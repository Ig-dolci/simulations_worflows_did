...
import argparse
# 3D mesh cases (elem_x x elem_y x elem_z)
# case 1 - 26x26x13 mesh
# case 2 - 30x30x15 mesh
# case 3 - 34x34x17 mesh
# case 4 - 38x38x19 mesh
# case 5 - 42x42x21 mesh
# case 6 - 46x46x23 mesh
# case 7 - 50x50x25 mesh
# case 8 - 54x54x27 mesh
# case 9 - 58x58x29 mesh
# case 10 - 62x62x31 mesh
# case 11 - 66x66x33 mesh
# case 12 - 70x70x35 mesh
# case 13 - 74x74x37 mesh
# reference case - 80x80x40 mesh
M = 1
...
parser.add_argument('--elem-x', type=int, default=26, help='Number of elements in x direction')
parser.add_argument('--elem-y', type=int, default=26, help='Number of elements in y direction')
parser.add_argument('--elem-z', type=int, default=13, help='Number of elements in z direction')
...
mesh = BoxMesh(elem_x, elem_y, elem_z, lx, ly, lz)
...
if comm.rank == 0:
    # All processes should have the same data (interpolated at same receiver location)
    # We just take the data from rank 0 since receivers are the same across processes
    print(f"Saving results to {file_name}")
    np.save(file_name, gathered_data[0])
