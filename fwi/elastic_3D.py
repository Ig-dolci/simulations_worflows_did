...
mesh = ExtrudedMesh(
    RectangleMesh(96, 96, 2, 2, comm=my_ensemble.comm, quadrilateral=True),
...
vs_true = Function(V0).interpolate(3.0)
rho = Function(V0).interpolate(2.0)
vp_true = Function(V0).interpolate(4.5)
