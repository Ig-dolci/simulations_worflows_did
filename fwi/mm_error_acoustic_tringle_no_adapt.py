...
parser = argparse.ArgumentParser(description='Run acoustic wave simulation with triangular mesh')
parser.add_argument('--case', type=str, default='11', help='Case number or "ref" for reference')
parser.add_argument('--elem-x', type=int, default=418, help='Number of elements in x direction')
parser.add_argument('--elem-y', type=int, default=204, help='Number of elements in y direction')
...
# case 8 - 290x145 mesh
# case 9 - 340x170 mesh
# case 10 - 390x180 mesh
# case 11 - 418x204 mesh
# case 12 - 425x214 mesh
# case 13 - 444x222 mesh
# reference case - 502x251 mesh

# Use arguments from command line
elem_x = args.elem_x
elem_y = args.elem_y
file_name = f"comp_performance/rec_data_triangle_no_adaptive_acoustic_{args.case}.npy"
...
mesh = RectangleMesh(elem_x, elem_y,
                     ...
                     distribution_parameters={"partitioner_types": "ptscotch"})
