...
# The program to test
mprof run -o no_revolve_interpolate_recompute python memory_leak.py --function "interpolate" --checkpoint "False" --annotate "True"
mprof run -o no_revolve_burger_recompute python memory_leak.py --function "burger" --checkpoint "False" --annotate "True"
mprof run -o no_revolve_assign_recompute python memory_leak.py --function "assign" --checkpoint "False" --annotate "True"
mprof run -o revolve_s10_interpolate_recompute python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s10_burger_recompute python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s10_assign_recompute python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s100_interpolate_recompute python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s100_burger_recompute python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s100_assign_recompute python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s200_interpolate_recompute python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s200_burger_recompute python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s200_assign_recompute python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s400_interpolate_recompute python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 400
mprof run -o revolve_s400_burger_recompute python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 400
mprof run -o revolve_s400_assign_recompute python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 400
