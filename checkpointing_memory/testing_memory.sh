...
mprof run -o no_annotation_interpolate python memory_leak.py --function "interpolate" --annotate "False"
mprof run -o no_annotation_burger python memory_leak.py --function "burger" --annotate "False"
mprof run -o no_annotation_assign python memory_leak.py --function "assign" --annotate "False"
mprof run -o no_revolve_interpolate python memory_leak.py --function "interpolate" --checkpoint "False" --annotate "True"
mprof run -o no_revolve_burger python memory_leak.py --function "burger" --checkpoint "False" --annotate "True"
mprof run -o no_revolve_assign python memory_leak.py --function "assign" --checkpoint "False" --annotate "True"
mprof run -o revolve_s10_interpolate python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s10_burger python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s10_assign python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 10
mprof run -o revolve_s100_interpolate python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s100_burger python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s100_assign python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 100
mprof run -o revolve_s200_interpolate python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s200_burger python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s200_assign python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 200
mprof run -o revolve_s400_interpolate python memory_leak.py --function "interpolate" --checkpoint "True" --annotate "True" --n_checkpoints 400
mprof run -o revolve_s400_burger python memory_leak.py --function "burger" --checkpoint "True" --annotate "True" --n_checkpoints 400
mprof run -o revolve_s400_assign python memory_leak.py --function "assign" --checkpoint "True" --annotate "True" --n_checkpoints 400
